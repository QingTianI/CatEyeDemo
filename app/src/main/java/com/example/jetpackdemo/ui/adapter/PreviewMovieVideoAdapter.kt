...
import com.example.jetpackdemo.databinding.ItemPreviewMovieVideoBinding

class PreviewMovieVideoAdapter : BaseQuickAdapter<VideoPreview.Data, BaseViewHolder> {
    constructor(list: MutableList<VideoPreview.Data>) : super(
        R.layout.item_preview_movie_video,
        list
    ...
    override fun onItemViewHolderCreated(viewHolder: BaseViewHolder, viewType: Int) {
        ...
        DataBindingUtil.bind<ItemPreviewMovieVideoBinding>(viewHolder.itemView)
    }

    override fun convert(holder: BaseViewHolder, item: VideoPreview.Data) {

        BaseDataBindingHolder<ItemPreviewMovieVideoBinding>(holder.itemView).dataBinding?.apply {
            this.data = item
